"""``k8s-aiops undo`` — list recorded undo tokens and apply them.
...
path as any other write (the inverse tool it dispatches is itself governed and
audited).
"""
...
def undo_list_cmd(
    ...
    if result.get("truncated"):
        console.print(
            ...
            f"undo tokens — truncated, re-run with a higher --limit.[/yellow]"
        )

...
DEFAULT_RULES_YAML = """\
# k8s-aiops policy rules — hot-reloaded on change (no restart needed).
...
risk_tiers:
  - name: high-risk-requires-approver
    ...
    reason: >-
      ...
      K8S_AUDIT_APPROVED_BY (and K8S_AUDIT_RATIONALE) before the call.

# deny:
#   - name: no-prod-deletes
#     operations: ["delete_*", "drain_node"]
#     environments: ["production"]
#     reason: "Deletes/drains in production go through change management."
